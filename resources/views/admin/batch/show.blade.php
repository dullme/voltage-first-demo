                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-6">
                                ...
                                <p>Ocean Forwarder：{{ $batch->oceanForwarder->forwarder->name }} : {{ $batch->oceanForwarder->name }}</p>
                                <p>B/L：{{ $batch->b_l }}</p>
                                <p>RMB：{{ $batch->rmb }}</p>
                            ...
                            <div class="col-lg-6">
                                ...
                                <p>Inland Forwarder：{{ $batch->inlandForwarder->forwarder->name }} : {{ $batch->inlandForwarder->name }}</p>
